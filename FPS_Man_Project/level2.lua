...
function scene:create( event )                        
    ...
    physics.setGravity( 0, 30 )                                             -- changing gravity of world (9.8 is gravity of earth)
    ...
    platform, platformFassade, platformGround_list = spawnPlatform( 156, 174, 2, 3 )                             -- adding level component
    platform, platformFassade, platformGround_list = spawnPlatform( 364, 226, 2, 2 )                             -- adding level component
    platform, platformFassade, platformGround_list = spawnPlatform( 19*52, 225, 2, 2 )                             -- adding level component
    platform, platformFassade, platformGround_list = spawnPlatform( 26*52, 225, 2, 2 )                             -- adding level component
    platform, platformFassade, platformGround_list = spawnPlatform( 30*52, 121, 2, 4 )                             -- adding level component
