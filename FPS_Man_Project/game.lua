...
function scene:create( event )                        
    ...
    platform = spawnPlatform(60,200,80,10)                      -- adding level components
    platform:setFillColor(1,0,0)
    platform1 = spawnPlatform(220,200,80,10)                    -- adding level components
    increaseObject = spawnIncreasingObject(890,110)             -- adding level components
    increaseObject1 = spawnIncreasingObject(969,245)            -- adding level components
    increaseObject2 = spawnIncreasingObject(643,157)            -- adding level components
    increaseObject3 = spawnIncreasingObject(827,12)             -- adding level components
    decreaseObject = spawnIncreasingObject(337,253)             -- adding level components
    decreaseObject1 = spawnDecreasingObject(817,112)            -- adding level components
    decreaseObject2 = spawnIncreasingObject(86,227)             -- adding level components
    decreaseObject3 = spawnDecreasingObject(734,60)             -- adding level components
    platform2 = spawnPlatform(460,200,80,10)                    -- adding level components
    platform3 = spawnPlatform(700,200,80,10)                    -- adding level components
    platform4 = spawnPlatform(940,200,80,10)                    -- adding level components
    finishPlatform = spawnPlatform(950,310,100,10)              -- adding level components
